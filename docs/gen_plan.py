...
for line in md.split("\n"):
    ...
    LINK_MAP=[
        ...
        (r'301\s*作文立意[^＋]*', R+'资料/301_综合素质/301.05答题模板.html', 3),
        (r'作文立意[^＋]*', R+'资料/301_综合素质/301.05答题模板.html', 3),
        (r'301.*模板[^＋]*', R+'资料/301_综合素质/301.05答题模板.html', 3),
        (r'301\s*材料分析[^＋]*', R+'资料/301_综合素质/301.05答题模板.html', 3),
        (r'材料分析[^＋]*', R+'资料/301_综合素质/301.05答题模板.html', 3),
        ...
        (r'作文1篇[^＋]*', R+'资料/301_综合素质/作文库/作文目录.html', 6),
        (r'总结', R+'资料/00_考试总览/每日总结.html', 7),
    ]
